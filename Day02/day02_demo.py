"""
Day 02 Demo: Foundations of NLP and Transformers
...
- Tokens are shown as a list.
- Token count is displayed.
- Context examples show 'bank' with different meanings.
- Attention demo highlights important words in uppercase and brackets.
